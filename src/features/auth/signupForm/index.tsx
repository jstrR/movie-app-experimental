  ...
  return (
    <>
      <form className="mt-8 mb-3 text-xl text-blue-500 flex flex-col justify-center items-center w-full gap-y-6" onSubmit={onSubmit}>
        <input type="text" className="border-2 rounded py-1 px-2 placeholder:text-base placeholder:italic placeholder:text-slate-400 w-5/6 sm:w-3/5" placeholder="Name" aria-label="Name" name="userName" value={name} onChange={e => setName(e.target.value)} required />
        ...
        <input type="password" className="border-2 rounded py-1 px-2 placeholder:text-base placeholder:italic placeholder:text-slate-400 w-5/6 sm:w-3/5" placeholder="Repeat password" aria-label="Repeat password" name="userRepPassword" value={repPassword} onChange={e => setRepPassword(e.target.value)} required />
        <button disabled={isSubmitDisabled} aria-disabled={isSubmitDisabled} className="mt-2 px-10 py-1 text-xl disabled:text-rose-300 hover:text-rose-400 text-rose-600 flex justify-center items-center border-2 rounded border-rose-600 disabled:border-rose-300 hover:border-rose-400 w-5/6 sm:w-3/5" type="submit">Sign Up!</button>
      </form>
